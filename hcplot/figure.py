        ...
        for row in range(self.rows):
            for col in range(self.cols):
                ...
                if i < self.count:
                    ...
                    fig.addXAxis(title=None, max=self.xmax, min=self.xmin, lineWidth=1, tickWidth=1, gridLineWidth=1)
                    fig.addYAxis(title=None, max=self.ymax, min=self.ymin, lineWidth=1, tickWidth=1, gridLineWidth=1)
