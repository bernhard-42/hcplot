...
def spline(values):
    ...
    def basis(t1, v0, v1, v2, v3):
        t2 = t1 * t1
        t3 = t2 * t1
        return (   (1 - 3 * t1 + 3 * t2 -     t3) * v0  # noqa E201,E222
                 + (4 - 6 *          t2 + 3 * t3) * v1  # noqa E201,E222
                 + (1 + 3 * t1 + 3 * t2 - 3 * t3) * v2  # noqa E201,E222
                 +                            t3  * v3  # noqa E201,E222
               ) / 6
    ...
    def f(t, n):
        ...
        v1 = values[i]
        v2 = values[i + 1]
        v0 = values[i - 1] if i > 0     else 2 * v1 - v2  # noqa E201
